...
const Comment = ({ articleId, user, allComments, refetchComments }) => {
    ...
    const handleComment = () => {
        ...
        mutation.mutate(stateComment, {
            onSuccess: (res) => {
                setLatestCommentId(res.data._id) // Lưu id để scroll tới
                refetchComments()
            }
        })
        setStateComment({
        ...
        return (
            ...
            >
                ...
                {comment.replies && comment.replies.length > 0 && (
                    <VStack align='left' mt={2} pl={4} borderLeftWidth="2px" borderLeftColor={borderColor}>
